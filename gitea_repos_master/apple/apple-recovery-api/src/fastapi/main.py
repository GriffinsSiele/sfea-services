...
from src.fastapi.router import apple_router
from src.fastapi.schemas import AppleSearchResponse
from src.fastapi.server import AppleFastAPI
...
async def prepare_not_found_response(exc: RequestValidationError) -> JSONResponse:
    ...
    source_incorrect_data = ResponseAdapter.error(
...
async def common_error(e: Exception) -> JSONResponse:
    ...
    """
    logging.warning(e)
    internal_error = AppleSearchResponse(**KeyDBResponseBuilder.error(e))
    result = JSONResponse(
