...
class SeleniumBrowser(AbstractBrowser):
    ...
    def get_element(self, by: By, selector: str) -> WebElement | None:
        return self.reload_page_wrapper(self._get_element)(by, selector)

    @webdriver_exception_handler
    def _get_element(self, by: By, selector: str) -> WebElement | None:
        try:
    ...
    def get_element_and_clear(self, by: By, selector: str) -> WebElement | None:
        return self.reload_page_wrapper(self._get_element_and_clear)(by, selector)

    @webdriver_exception_handler
    def _get_element_and_clear(self, by: By, selector: str) -> WebElement | None:
    ...
    def get_loaded_element(self, by: By, selector: str) -> WebElement | None:
        return self.reload_page_wrapper(self._get_loaded_element)(by, selector)

    @webdriver_exception_handler
    def _get_loaded_element(self, by: By, selector: str) -> WebElement | None:
    ...
    def get_element_and_click(self, by: By, selector: str) -> None:
        return self.reload_page_wrapper(self._get_element_and_click)(by, selector)

    @webdriver_exception_handler
    def _get_element_and_click(self, by: By, selector: str) -> None:
        """
    ...
    def get_element_and_set_data(
        ...
        return self.reload_page_wrapper(self._get_element_and_set_data)(
            by, selector, data
        )

    @webdriver_exception_handler
    def _get_element_and_set_data(
        self, by: By, selector: str, data: str
    ) -> WebElement | None:
        """
    ...
    def get_element_set_data_and_enter(self, by: By, selector: str, data: str) -> None:
        return self.reload_page_wrapper(self._get_element_set_data_and_enter)(
            by, selector, data
        )

    @webdriver_exception_handler
    def _get_element_set_data_and_enter(self, by: By, selector: str, data: str) -> None:
        """
    ...
    def reload_page_wrapper(self, func: Callable) -> Callable:
        @functools.wraps(func)
        def wrapper(*args, **kwargs) -> Any:
            error: WebDriverException | None = None
            for attempt in range(ConfigApp.MAX_GET_ELEMENT_ATTEMPTS):
                try:
                    return func(*args, **kwargs)
                except WebDriverException as e:
                    error = e
                    logging.warning(
                        f"Failed execute {func.__name__} args: {args} kwargs: {kwargs}, "
                        f"attempt {attempt} of {ConfigApp.MAX_GET_ELEMENT_ATTEMPTS}, exception: "
                        + str(e).replace("\n", " ")
                    )
                    self.driver.implicitly_wait(self.implicitly_wait_delay)
