...
router = APIRouter(prefix="/huawei/email", tags=["huawei-email"])
...
@router.post(
    ...
    description="Parse an email address using Huawei service",
...
async def parse_email(
    ...
    """
    Parse an email address using the Huawei service.
