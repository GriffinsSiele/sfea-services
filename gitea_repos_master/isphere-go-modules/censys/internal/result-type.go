	...
	return &IPItemType{
		Object: graphql.NewObject(graphql.ObjectConfig{
			...
			Fields: graphql.Fields{
				"ip":           {Type: graphql.NewNonNull(graphql.String)},
				"country":      {Type: graphql.String},
				"country_code": {Type: graphql.String},
				"province":     {Type: graphql.String},
				"city":         {Type: graphql.String},
				"timezone":     {Type: graphql.String},
				"asn":          {Type: graphql.String},
				"organization": {Type: graphql.String},
...
func NewServiceItemType() *ServiceItemType {
	return &ServiceItemType{
		Object: graphql.NewObject(graphql.ObjectConfig{
			Name: "service",
			Fields: graphql.Fields{
				"service":   {Type: graphql.NewNonNull(graphql.String)},
				"port":      {Type: graphql.NewNonNull(graphql.Int)},
				"transport": {Type: graphql.String},
			},
		}),
	}
}
