...
//                        "Connection: keep-alive\n" .
                ...
                if ($captcha_format=='json') {
                    $get_options['http']['header'] .= "Accept: application/json, text/javascript, */*; q=0.01\n";
                }
                if ($proxy) {
...
//                        "Connection: keep-alive\r\n" .
            ...
            while ($form && $captcha_url && !$captcha && (microtime(true)-$starttime < $max_seconds)) {
                $captcha_url = (substr($captcha_url,0,4)=='http' ? '' : $url) . $captcha_url;
                $get_options = array('http' => array(
                    'method' => 'GET',
                    'timeout' => $http_timeout,
...
//                        "Connection: keep-alive\r\n" .
                ...
                if ($captcha_format=='json') {
                    $get_options['http']['header'] .= "Accept: application/json, text/javascript, */*\n";
                }
                if ($proxy) {
                    $get_options['http']['proxy'] = $proxy;
//                    $get_options['http']['request_fulluri'] = true;
...
//                            print_log($form);
            ...
            if ($form && $captcha_format && ($captcha || !$captcha_url)) {
