...
$daemonnum = "getcontact";
$sessiontable = "session_getcontact session";
$sourcefilter = " AND id=55";
$proxyfilter = ""; //" AND mod(id,10)+1=$daemonnum";
$sourceaccessfilter = ""; //" AND mod(sourceaccessid,10)+1=0";
$sessionfilter = ""; //" AND session.sourceid=55"; //" AND (proxyid IS NULL OR mod(session.proxyid,10)+1=$daemonnum)";
...
// Удаляем капчи с истекшим сроком
    $sql = <<<SQL
update $sessiontable SET captcha='',captchaimage=NULL,statuscode='captchaexpired'
