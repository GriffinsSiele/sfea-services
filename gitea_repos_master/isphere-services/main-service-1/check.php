...
<script src="main.js?20240826"></script>
...
<form id="checkform" method="POST">
    <table>
        ...
        <tr>
            <td>Дата рождения</td>
            <td>
                <input type="text" id="date" name="date" value="<?=$_REQUEST['date']?>" data-type="date" maxlength="50" />
            </td>
        </tr>
        ...
        <tr>
	     ...
	     <td>
	         <input type="text" name="issueDate" value="<?=$_REQUEST['issueDate']?>" data-type="date" maxlength="10" />
	     </td>
        </tr>
        <tr>
            <td>ИНН</td>
        ...
        <tr>
	     ...
	     <td>
	         <input type="text" name="driver_date" value="<?=$_REQUEST['driver_date']?>" data-type="date" maxlength="10" />
	     </td>
        </tr>
        <tr>
        ...
        <!--tr>
            ...
            <td>
                <input type="text" id="reqdate" name="reqdate" value="<?=$_REQUEST['reqdate']?>" data-type="date" maxlength="50" />
            </td>
        </tr-->
        <!--tr>
...
if ($_REQUEST['mode']=='xml') {
    ...
    if ($doc) {
        ...
        echo strtr($doc->saveHTML(),array('___servicename___'=>$servicename));
    } else {
