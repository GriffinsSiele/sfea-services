...
<h1>Проверка карты</h1><hr/><a href="admin.php">Назад</a><br/><br/>
<form id="checkform" method="POST">
    <table>
        <tr>
            <td>Номер карты<span class="req">*</span></td>
            <td>
                <input type="text" name="card" value="<?=$_REQUEST['card']?>" required="1" maxlength="25" />
            </td>
        </tr>
        <!--tr>
...
. (!isset($_REQUEST['request_id']) || !$_REQUEST['request_id']? "" : "
        ...
        <requestType>checkcard</requestType>
