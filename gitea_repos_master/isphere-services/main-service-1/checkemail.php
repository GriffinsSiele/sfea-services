...
$check_sources = array(
  'gosuslugi_email'=>array('Госуслуги',1,0,1),
...
//  'papajohns'=>array('Папа Джонс',1,1,0),
  ...
  'petrovich'=>array('Петрович',1,1,0),
...
<h1>Проверка email</h1><hr/><a href="admin.php">Назад</a><br/><br/>
<form id="checkform" method="POST">
    <table>
        <tr>
            <td>Email<span class="req">*</span></td>
            <td>
                <input type="text" name="email" value="<?=$_REQUEST['email']?>" required="1" maxlength="100" />
            </td>
        </tr>
        <!--tr>
...
. (!isset($_REQUEST['request_id']) || !$_REQUEST['request_id']? "" : "
        ...
        <requestType>checkemail</requestType>
