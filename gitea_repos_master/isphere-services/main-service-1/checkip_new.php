...
$check_sources = array(
  'dns'=>array('DNS',1,0,0),
  'libloc'=>array('Libloc',1,0,0),
  'geoip'=>array('GeoIP',1,0,0),
  'sypexgeo'=>array('SypexGeo',1,0,1),
  'ripe'=>array('RIPE',1,0,0),
  'shodan'=>array('Shodan',1,0,0),
  'censys'=>array('Censys',1,0,1),
...
<h1>Проверка ip-адреса</h1><hr/><a href="admin.php">Назад</a><br/><br/>
<form id="checkform" method="POST">
    <table>
        <tr>
            <td>IP-адрес<span class="req">*</span></td>
            <td>
                <input type="text" name="ip" value="<?=$_REQUEST['ip']?>" required="1" maxlength="15" />
            </td>
        </tr>
        <!--tr>
...
. (!isset($_REQUEST['request_id']) || !$_REQUEST['request_id']? "" : "
        ...
        <requestType>checkip</requestType>
