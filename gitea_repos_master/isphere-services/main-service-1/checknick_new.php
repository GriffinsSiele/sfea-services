...
<h1>Проверка псевдонима</h1><hr/><a href="admin.php">Назад</a><br/><br/>
<form id="checkform" method="POST">
    <table>
        <tr>
            <td>Псевдоним<span class="req">*</span></td>
            <td>
                <input type="text" name="nick" value="<?=$_REQUEST['nick']?>" required="1" maxlength="100" />
            </td>
        </tr>
        <!--tr>
...
. (!isset($_REQUEST['request_id']) || !$_REQUEST['request_id']? "" : "
        ...
        <requestType>checknick</requestType>
