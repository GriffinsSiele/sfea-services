...
$check_sources = array(
  'fssp'=>array('ФССП',1,1,0),
  'fsspapi'=>array('ФССП API',1,1,1),
  'rsa_bsostate'=>array('РСА полис',1,1,1),
);

if (!isset($_REQUEST['fsspip'])) $_REQUEST['fsspip']='';
...
<form id="checkform" method="POST">
    <table>
        <tr>
            ...
            <td>
                <input type="text" name="fsspip" value="<?=$_REQUEST['fsspip']?>" maxlength="100" />
            </td>
        </tr>
        <tr>
            <td>Полис ОСАГО</td>
