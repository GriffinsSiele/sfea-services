...
<h1>Проверка телефона (Португалия)</h1><hr/><a href="admin.php">Назад</a><br/><br/>
<form id="checkform" method="POST">
    <table>
        <tr>
            <td>Номер телефона<span class="req">*</span></td>
            <td>
                <input type="text" name="phone" value="<?=$_REQUEST['phone']?>" required="1" maxlength="50" />
            </td>
        </tr>
        <!--tr>
...
. (!isset($_REQUEST['request_id']) || !$_REQUEST['request_id']? "" : "
        ...
        <requestType>checkphone_pt</requestType>
