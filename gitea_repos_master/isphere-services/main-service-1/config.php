...
use App\OpenTracing\Jaeger;

require_once __DIR__ . '/vendor/autoload.php';

$showDisplayErrors = false;
if (getenv('DISPLAY_ERRORS')) {
    $showDisplayErrors = true;
}

ini_set("display_errors", (int) $showDisplayErrors);
...
$proxphere = '172.16.100.1'; //getenv('PROXPHERE');
