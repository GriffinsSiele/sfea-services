...
class AlfabankRPlugin implements PluginInterface
{
...
//            file_put_contents('./logs/raiffeisen/alfabank_'.time().'.txt',$content);
...
*/
                ...
                file_put_contents('./logs/raiffeisen/alfabank_err_'.time().'.txt',$content);
