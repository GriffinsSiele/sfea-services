...
class GazprombankRPlugin implements PluginInterface
{
...
//            file_put_contents('./logs/raiffeisen/gazprombank_'.time().'.txt',$content);
...
*/
                ...
                file_put_contents('./logs/raiffeisen/gazprombank_err_'.time().'.txt',$content);
