...
class PSBankRPlugin implements PluginInterface
{
...
//            file_put_contents('./logs/raiffeisen/psbank_'.time().'.txt',$content);
...
*/
                ...
                file_put_contents('./logs/raiffeisen/psbank_err_'.time().'.txt',$content);
