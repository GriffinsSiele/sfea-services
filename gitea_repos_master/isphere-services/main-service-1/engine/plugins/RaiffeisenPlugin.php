...
class RaiffeisenPlugin implements PluginInterface
{
...
//            file_put_contents('./logs/raiffeisen/raiffeisen_'.time().'.txt',$content);
...
*/
                ...
                file_put_contents('./logs/raiffeisen/raiffeisen_err_'.time().'.txt',$content);
