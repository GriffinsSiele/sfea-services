...
class RosbankRPlugin implements PluginInterface
{
...
//            file_put_contents('./logs/raiffeisen/rosbank_'.time().'.txt',$content);
...
*/
                ...
                file_put_contents('./logs/raiffeisen/rosbank_err_'.time().'.txt',$content);
