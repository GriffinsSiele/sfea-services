...
class SovcombankRPlugin implements PluginInterface
{
...
//            file_put_contents('./logs/raiffeisen/sovcombank_'.time().'.txt',$content);
...
*/
                ...
                file_put_contents('./logs/raiffeisen/sovcombank_err_'.time().'.txt',$content);
