...
*/
        ...
        $result = $mysqli->query("SELECT * FROM fedsfm.fedsfm WHERE lastname='".$last_name."' and firstname='".$first_name."'".($middle_name?" and middlename='".$middle_name."'":"").($birth_date?" and (birthdate='' or birthdate='".$birth_date."')":""));
        if ($result) {
