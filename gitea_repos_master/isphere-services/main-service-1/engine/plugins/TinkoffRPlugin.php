...
class TinkoffRPlugin implements PluginInterface
{
...
//            file_put_contents('./logs/raiffeisen/tinkoff_'.time().'.txt',$content);
...
*/
                ...
                file_put_contents('./logs/raiffeisen/tinkoff_err_'.time().'.txt',$content);
