...
if(isset($_REQUEST['operation']) && $_REQUEST['operation']=='add' && isset($_REQUEST['source'])) {

    if (!isset($_REQUEST['token'])) $_REQUEST['token']='';
    if (!isset($_REQUEST['enckey'])) $_REQUEST['enckey']='';
    if (!isset($_REQUEST['device'])) $_REQUEST['device']='';
    if (!isset($_REQUEST['cookies'])) $_REQUEST['cookies']='';
    if (!isset($_REQUEST['data'])) $_REQUEST['data']='';
    if (!isset($_REQUEST['proxy'])) $_REQUEST['proxy']='null';
    ...
    if (isset($_REQUEST['proxy']) && ($_REQUEST['proxy']!='null') && !is_numeric($_REQUEST['proxy'])) {
