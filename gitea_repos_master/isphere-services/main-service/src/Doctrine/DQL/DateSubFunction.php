...
class DateSubFunction extends FunctionNode
{
    private readonly Node $node1;
    private readonly Node $node2;
    private readonly Node $node3;
    ...
    public function parse(Parser $parser): void
    {
        ...
        $this->node3 = $parser->ArithmeticPrimary();
