...
$view['slots']->set('title', 'Проверка карты');
                ...
                <form id="checkform" method="POST">
                    <div class="form-group row mb-3">
                        <label for="card" class="col-sm-3 col-form-label">
                            Номер карты<span class="req">*</span>
                        </label>
                        <div class="col-sm-4">
                            <input type="text" name="card" value="<?php echo $_REQUEST['card']; ?>" required="1"
                                   maxlength="25" id="card" autofocus class="form-control"/>
                        </div>
                    </div>
