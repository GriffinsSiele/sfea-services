...
$view['slots']->set('title', 'Проверка e-mail');
            ...
            <div class="col">
                <form id="checkform" method="POST">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="email" value="<?php echo $_REQUEST['email']; ?>" required="1"
                                   maxlength="100" class="form-control" id="email" autofocus/>
                        </div>
                    </div>
