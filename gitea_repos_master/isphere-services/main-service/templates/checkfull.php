...
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['fssp'])) {
    $_REQUEST['sources']['fssp'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['fms'])) {
    $_REQUEST['sources']['fms'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['fns'])) {
    $_REQUEST['sources']['fns'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['bankrot'])) {
    $_REQUEST['sources']['bankrot'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['terrorist'])) {
    $_REQUEST['sources']['terrorist'] = 1;
}
// if(!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['rz']))  $_REQUEST['sources']['rz'] = 1;
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['people'])) {
    $_REQUEST['sources']['people'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['vk'])) {
    $_REQUEST['sources']['vk'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['ok'])) {
    $_REQUEST['sources']['ok'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['rossvyaz'])) {
    $_REQUEST['sources']['rossvyaz'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['hlr'])) {
    $_REQUEST['sources']['hlr'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['facebook'])) {
    $_REQUEST['sources']['facebook'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['beholder'])) {
    $_REQUEST['sources']['beholder'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['hh'])) {
    $_REQUEST['sources']['hh'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['announcement'])) {
    $_REQUEST['sources']['announcement'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['boards'])) {
    $_REQUEST['sources']['boards'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['skype'])) {
    $_REQUEST['sources']['skype'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['viber'])) {
...
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['commerce'])) {
    $_REQUEST['sources']['commerce'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['yamap'])) {
    $_REQUEST['sources']['yamap'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['2gis'])) {
    $_REQUEST['sources']['2gis'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['tc'])) {
    $_REQUEST['sources']['tc'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['numbuster'])) {
    $_REQUEST['sources']['numbuster'] = 1;
}
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['sberbank'])) {
    $_REQUEST['sources']['sberbank'] = 1;
}
// if(!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['avinfo']))  $_REQUEST['sources']['avinfo'] = 1;
if (!isset($_REQUEST['mode']) && !isset($_REQUEST['sources']['phonenumber'])) {
...
if (!isset($_REQUEST['issueAuthority'])) {
    $_REQUEST['issueAuthority'] = '';
}
if (!isset($_REQUEST['placeOfBirth'])) {
...
if (!isset($_REQUEST['homeaddress'])) {
    $_REQUEST['homeaddress'] = '';
}
if (!isset($_REQUEST['homeaddressArr'])) {
    $_REQUEST['homeaddressArr'] = '';
}
if (!isset($_REQUEST['regaddress'])) {
    $_REQUEST['regaddress'] = '';
}
if (!isset($_REQUEST['regaddressArr'])) {
...
<form id="checkform" method="POST">
    <table>
        ...
        <tr>
            <td>Дата рождения</td>
            <td>
                <input type="text" id="date" name="date" value="<?php echo $_REQUEST['date']; ?>" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01])\.(0[1-9]|1[012])\.[0-9]{4}" data-type="date" maxlength="50" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="passport_series" value="<?php echo $_REQUEST['passport_series']; ?>" maxlength="4" />
            </td>
        </tr>
        <tr>
	...
	<tr>
	     ...
	     <td>
	         <input type="text" name="issueAuthority" value="<?php echo $_REQUEST['issueAuthority']; ?>" maxlength="300" />
	     </td>
	</tr>
        <tr>
	    <td>Место рождения</td>
	    <td>
	        <input type="text" name="placeOfBirth" value="<?php echo $_REQUEST['placeOfBirth']; ?>" maxlength="300" />
	    </td>
	</tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="mobile_phone" value="<?php echo $_REQUEST['mobile_phone']; ?>" maxlength="20" />
            </td>
        </tr>
        <tr>
            <td>Домашний телефон<span class="req"></span></td>
            <td>
                <input type="text" name="home_phone" value="<?php echo $_REQUEST['home_phone']; ?>" maxlength="20" />
            </td>
        </tr>
        <tr>
            <td>Рабочий телефон<span class="req"></span></td>
            <td>
                <input type="text" name="work_phone" value="<?php echo $_REQUEST['work_phone']; ?>" maxlength="20" />
            </td>
        </tr>
        <tr>
            <td>Дополнительный телефон<span class="req"></span></td>
            <td>
                <input type="text" name="additional_phone" value="<?php echo $_REQUEST['additional_phone']; ?>" maxlength="20" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
	     ...
	     <td><input class="address" id="homeaddress" name="homeaddress" type="text" size="100" value="<?php echo $_REQUEST['homeaddress']; ?>" />
	         <input type="hidden" id="homeaddressArr" name="homeaddressArr" size="1000" value="<?php echo \htmlspecialchars($_REQUEST['homeaddressArr']); ?>" />
	     </td>
	</tr>
	<tr>
	     <td>Совпадает</td>
	     <td><input type="checkbox" <?php echo $_REQUEST['same'] ? 'checked' : ''; ?> name="same" id="same"></td>
	</tr>
	<tr>
	     <td>Адрес регистрации</td>
	     <td><input class="address" id="regaddress" name="regaddress" type="text" size="100" value="<?php echo $_REQUEST['regaddress']; ?>" />
	         <input type="hidden" id="regaddressArr" name="regaddressArr" size="1000" value="<?php echo \htmlspecialchars($_REQUEST['regaddressArr']); ?>" />
	     </td>
	</tr>
        <tr>
            <td>Источники</td>
            <td>
                <input type="checkbox" <?php echo $_REQUEST['sources']['fssp'] ? 'checked' : ''; ?> name="sources[fssp]"> ФССП
                <!--input type="checkbox" <?php echo $_REQUEST['sources']['fsspsite'] ? 'checked' : ''; ?> name="sources[fsspsite]"> ФССП (сайт) -->
                <input type="checkbox" <?php echo $_REQUEST['sources']['fms'] ? 'checked' : ''; ?> name="sources[fms]"> ФМС
                <input type="checkbox" <?php echo $_REQUEST['sources']['fns'] ? 'checked' : ''; ?> name="sources[fns]"> ФНС
                <br/>
                <input type="checkbox" <?php echo $_REQUEST['sources']['bankrot'] ? 'checked' : ''; ?> name="sources[bankrot]"> Банкроты
                <input type="checkbox" <?php echo $_REQUEST['sources']['terrorist'] ? 'checked' : ''; ?> name="sources[terrorist]"> Террористы
		<input type="checkbox" <?php echo $_REQUEST['sources']['rz'] ? 'checked' : ''; ?> name="sources[rz]"> Реестр залогов
                <br/>
		<!-- input type="checkbox" <?php echo $_REQUEST['sources']['croinform'] ? 'checked' : ''; ?> name="sources[croinform]"> Кронос -->
		<!-- input type="checkbox" <?php echo $_REQUEST['sources']['nbki'] ? 'checked' : ''; ?> name="sources[nbki]"> НБКИ -->
                <br/>
		<input type="checkbox" <?php echo $_REQUEST['sources']['people'] ? 'checked' : ''; ?> name="sources[people]"> Соцсети
		<input type="checkbox" <?php echo $_REQUEST['sources']['vk'] ? 'checked' : ''; ?> name="sources[vk]"> VK
		<input type="checkbox" <?php echo $_REQUEST['sources']['ok'] ? 'checked' : ''; ?> name="sources[ok]"> OK
                <input type="checkbox" <?php echo $_REQUEST['sources']['facebook'] ? 'checked' : ''; ?> name="sources[facebook]"> Facebook
		<input type="checkbox" <?php echo $_REQUEST['sources']['beholder'] ? 'checked' : ''; ?> name="sources[beholder]"> Beholder
                <br/>
                <input type="checkbox" <?php echo $_REQUEST['sources']['rossvyaz'] ? 'checked' : ''; ?> name="sources[rossvyaz]"> Россвязь
                <input type="checkbox" <?php echo $_REQUEST['sources']['hlr'] ? 'checked' : ''; ?> name="sources[hlr]"> HLR
                <input type="checkbox" <?php echo $_REQUEST['sources']['ss7'] ? 'checked' : ''; ?> name="sources[ss7]"> HLR-2
                <br/>
<?php
if ($user_level > 0) {
    echo '
...
?>
		<input type="checkbox" <?php echo $_REQUEST['sources']['announcement'] ? 'checked' : ''; ?> name="sources[announcement]"> Объявления
		<input type="checkbox" <?php echo $_REQUEST['sources']['commerce'] ? 'checked' : ''; ?> name="sources[commerce]"> Commerce
                <br/>
                <input type="checkbox" <?php echo $_REQUEST['sources']['skype'] ? 'checked' : ''; ?> name="sources[skype]"> Skype
                <input type="checkbox" <?php echo $_REQUEST['sources']['viber'] ? 'checked' : ''; ?> name="sources[viber]"> Viber
                <input type="checkbox" <?php echo $_REQUEST['sources']['whatsapp'] ? 'checked' : ''; ?> name="sources[whatsapp]"> WhatsApp
                <!--input type="checkbox" <?php echo $_REQUEST['sources']['checkwa'] ? 'checked' : ''; ?> name="sources[checkwa]">  CheckWA -->
                <!--input type="checkbox" <?php echo $_REQUEST['sources']['telegram'] ? 'checked' : ''; ?> name="sources[telegram]"> Telegram -->
		<br />
		<input type="checkbox" <?php echo $_REQUEST['sources']['yamap'] ? 'checked' : ''; ?> name="sources[yamap]"> Яндекс.Карты
		<input type="checkbox" <?php echo $_REQUEST['sources']['2gis'] ? 'checked' : ''; ?> name="sources[2gis]"> 2ГИС
		<input type="checkbox" <?php echo $_REQUEST['sources']['sberbank'] ? 'checked' : ''; ?> name="sources[sberbank]"> Сбербанк
		<input type="checkbox" <?php echo $_REQUEST['sources']['tinkoff'] ? 'checked' : ''; ?> name="sources[tinkoff]"> Tinkoff
		<br />
		<input type="checkbox" <?php echo $_REQUEST['sources']['tc'] ? 'checked' : ''; ?> name="sources[tc]"> TrueCaller
		<input type="checkbox" <?php echo $_REQUEST['sources']['numbuster'] ? 'checked' : ''; ?> name="sources[numbuster]"> NumBuster
		<!--input type="checkbox" <?php echo $_REQUEST['sources']['avinfo'] ? 'checked' : ''; ?> name="sources[avinfo]"> AvInfo -->
		<input type="checkbox" <?php echo $_REQUEST['sources']['phonenumber'] ? 'checked' : ''; ?> name="sources[phonenumber]"> PhoneNumber
                <br/>
	    </td>
        </tr>
        <tr>
