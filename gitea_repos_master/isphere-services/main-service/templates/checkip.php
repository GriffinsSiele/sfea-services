...
$view['slots']->set('title', 'Проверка ip-адреса');
                ...
                <form id="checkform" method="POST">
                    <div class="form-group row mb-3">
                        <label for="ip" class="col-sm-3 col-form-label">
                            IP-адрес<span class="req">*</span>
                        </label>
                        <div class="col-sm-4">
                            <input type="text" name="ip" id="ip" value="<?php echo $_REQUEST['ip']; ?>" required="1"
                                   maxlength="15" class="form-control" autofocus/>
                        </div>
                    </div>
