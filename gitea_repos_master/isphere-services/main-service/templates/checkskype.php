...
foreach ($check_sources as $k => $s) {
    if (/* ($user_level<0) || */
        ...
        if ($_REQUEST['recursive'] && $s[2]) {
            $_REQUEST['sources'][$k] = 1;
        }
    }
}

$view['slots']->set('title', 'Проверка skype');
            ...
            <div class="col">
                <form id="checkform" method="POST">
                    <div class="form-group row mb-3">
                        <label for="skype" class="col-sm-3 col-form-label">
                            Skype<span class="req">*</span>
                        </label>
                        <div class="col-sm-4">
                            <input type="text" name="skype" value="<?php echo $_REQUEST['skype']; ?>" required="1"
                                   maxlength="100" class="form-control" id="skype" autofocus/>
                        </div>
                    </div>
...
<Request>
    ...
    . (!isset($_REQUEST['request_id']) || !$_REQUEST['request_id'] ? '' : "
        ...
        <requestType>checkskype</requestType>
