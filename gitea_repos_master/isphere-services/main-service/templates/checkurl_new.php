...
<h1>Проверка профиля</h1><hr/><a href="admin.php">Назад</a><br/><br/>
<form id="checkform" method="POST">
    <table>
        <tr>
            <td>Ссылка на профиль<span class="req">*</span></td>
            <td>
                <input type="text" name="url" value="<?php echo $_REQUEST['url']; ?>" required="1" maxlength="100" />
            </td>
        </tr>
        <!--tr>
...
?>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" <?php echo $_REQUEST['async'] ? 'checked' : ''; ?> name="async">
	    </td>
        </tr>
        <tr>
            <td>Формат ответа:</td>
