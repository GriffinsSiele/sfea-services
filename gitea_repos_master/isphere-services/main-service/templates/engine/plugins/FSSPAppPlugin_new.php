...
class FSSPAppPlugin_new implements PluginInterface
{
    ...
    public function computeRequest(array $params, &$rContext)
    {
        ...
        \file_put_contents('./logs/fsspapp/fssp_'.\time().'_'.$swapData['iteration'].'.txt', $content);
        ...
        if (isset($data['data']['captcha'])) {
                ...
                if (isset($element['name'])) {
                    ...
                    */
                    ...
                    foreach ($subjects as $subject) {
                        ...
                        $name = [
                            'Исполнительский сбор' => ['Bailiff', 'Сбор', 'Сумма сбора'],
                            'Задолженность по расходам' => ['Costs', 'Расходы', 'Сумма расходов'],
            ...
            \file_put_contents('./logs/fsspapp/fssp_err_'.\time().'_'.$swapData['iteration'].'.txt', $content);
