...
class FacebookPlugin_new implements PluginInterface
{
    private $names = [
                           'Образование' => ['education', 'Образование', 'Образование'],
                           'Работа' => ['career', 'Карьера', 'Карьера'],
                           'Умения и навыки' => ['expirience', 'Умения и навыки', 'Умения и навыки'],
                           'Места, в которых он жил' => ['places', 'Места проживания', 'Места проживания', 'block'],
                           'Места, в которых она жила' => ['places', 'Места проживания', 'Места проживания', 'block'],
                           'Места, в которых он(-а) проживал(-а)' => ['places', 'Места проживания', 'Места проживания', 'block'],
                           'Контактная информация' => ['contacts', 'Контакты', 'Контакты', 'block'],
                           'Основная информация' => ['info', 'Основная информация', 'Основная информация', 'block'],
                           'Другие имена' => ['aliases', 'Другие имена', 'Другие имена'],
                           'Семейное положение' => ['family', 'Семейное положение', 'Семейное положение'],
                           'Родственники' => ['relatives', 'Родственники', 'Родственники'],
                           'О пользователе' => ['about', 'О себе', 'О себе'],
                           'События из жизни' => ['events', 'События из жизни', 'События из жизни'],
                           'Любимые цитаты' => ['quotations', 'Любимые цитаты', 'Любимые цитаты'],
                           'Родной город' => ['birthplace', 'Родной город', 'Родной город'],
                           'Город проживания' => ['livingplace', 'Город проживания', 'Город проживания'],
                           'Город' => ['livingplace', 'Город проживания', 'Город проживания'],
                           'Район' => ['livingdistrict', 'Район', 'Район'],
                           'Адрес' => ['livingplace', 'Адрес', 'Адрес'],
                           'Переехал' => ['livingplace', 'Город проживания', 'Город проживания'],
                           'Купил' => ['livingplace', 'Город проживания', 'Город проживания'],
                           'Имя' => ['fullname', 'Имя', 'Имя'],
                           'Пол' => ['gender', 'Пол', 'Пол'],
                           'Предпочтения' => ['preferences', 'Предпочтения', 'Предпочтения'],
                           'Интересуют:' => ['interests', 'Интересуют', 'Интересуют'],
                           'Религиозные взгляды' => ['religion', 'Религия', 'Религия'],
                           'Политические взгляды' => ['politics', 'Политика', 'Политика'],
                           'Языки' => ['languages', 'Языки', 'Языки'],
                           'Умения и навыки' => ['skills', 'Умения и навыки', 'Умения и навыки'],
                           'Дата рождения' => ['birthdate', 'Дата рождения', 'Дата рождения'],
                           'День рождения' => ['birthday', 'День рождения', 'День рождения'],
                           'Год рождения' => ['birthyear', 'Год рождения', 'Год рождения'],
                           'Именины' => ['nameday', 'Именины', 'Именины'],
                           'Мобильный' => ['mobile_phone', 'Мобильный телефон', 'Мобильный телефон'/* , 'phone' */],
                           'Рабочий' => ['work_phone', 'Рабочий телефон', 'Рабочий телефон'/* , 'phone' */],
                           'Домашний' => ['home_phone', 'Домашний телефон', 'Домашний телефон'/* , 'phone' */],
                           'Skype' => ['skype', 'Skype', 'Skype', 'skype'],
                           'ICQ' => ['icq', 'ICQ', 'ICQ'],
                           'QIP' => ['qip', 'QIP', 'QIP'],
                           'AIM' => ['aim', 'AIM', 'AIM'],
                           'BBM' => ['bbm', 'BlackBerry Messenger', 'BlackBerry Messenger'],
                           'Live' => ['live', 'Windows Live Messenger', 'Windows Live Messenger'],
                           'LINE' => ['line', 'Line', 'Line'],
                           'Snapchat' => ['snapchat', 'Snapchat', 'Snapchat'],
                           'Google Talk' => ['google_talk', 'Google Talk', 'Google Talk'],
                           'Facebook' => ['facebook', 'Facebook', 'Facebook', 'url', 'https://www.facebook.com'],
                           'Twitter' => ['twitter', 'Twitter', 'Twitter', 'url:recursive'],
                           'Instagram' => ['instagram', 'Instagram', 'Instagram', 'url:recursive', 'https://www.instagram.com/'],
                           'YouTube' => ['youtube', 'YouTube', 'YouTube'],
                           'SoundCloud' => ['soundcloud', 'SoundCloud', 'SoundCloud'],
                           'Ask.fm' => ['askfm', 'Ask.fm', 'Ask.fm'],
                           'VK' => ['vk', 'VK', 'VK', 'url:recursive'],
                           'OK' => ['ok', 'OK', 'OK', 'url:recursive'],
                           'LinkedIn' => ['linkedin', 'LinkedIn', 'LinkedIn', 'url:recursive'],
                           'Веб-сайт' => ['website', 'Сайт', 'Сайт', 'url:recursive'],
                           'Веб-сайты' => ['website', 'Сайт', 'Сайт', 'url:recursive'],
                           'Электронный адрес' => ['email', 'Email', 'Email', 'email'],
                           'Эл. адрес' => ['email', 'Email', 'Email', 'email'],
                           'Эл. почта' => ['email', 'Email', 'Email', 'email'],
    ];
    ...
    public function getSessionData($sourceid = 18, $proxyid = false)
    {
        ...
        if ($sourceid) {
            ...
            $mysqli->query("UPDATE session s SET request_id=$reqId WHERE sessionstatusid=2 AND sourceid=$sourceid AND unix_timestamp(now())-unix_timestamp(lasttime)>10 ORDER BY lasttime limit 1");
    ...
    public function prepareRequest(array $params, &$rContext)
    {
        ...
        */
        ...
        if (!isset($swapData['session'])) {
            $swapData['session'] = $this->getSessionData('phone' == $checktype || 'email' == $checktype ? 31 : 18/* , ($checktype=='phone' || $checktype=='email') && ($swapData['iteration']>5) && rand(0,1)?9:false */);
        }
        if (!$swapData['session']) {
...
//                    '__spin_t' => '1637692869',
    ...
    public function computeRequest(array $params, &$rContext)
    {
        ...
        if (!$curlError) {
            ...
            if ('phone' == $checktype || 'email' == $checktype) {
                if (!isset($swapData['urls'])) {
                    \file_put_contents('./logs/facebook/face_identify_'.\time().'.html', \curl_getinfo($rContext->getCurlHandler(), \CURLINFO_HEADER_OUT)."\r\n".$content);
                    ...
                    if (isset($res['domops'][0][3]['__html'])) {
                        ...
                        \file_put_contents('./logs/facebook/face_identify_html_'.\time().'.html', $html);
                        if (\preg_match('/не найдено/', $html)) {
                            ...
                            \file_put_contents('./logs/facebook/face_identify_html_err_'.\time().'.html', $html);
                        }
                    } elseif (isset($res['onload'][0])) {
                        $onload = $res['onload'][0];
                        \file_put_contents('./logs/facebook/face_identify_onload_'.\time().'.html', $onload);
                        if (\preg_match('/window.location.href="([^"]+)"/', $onload, $matches)) {
                            $swapData['urls'][] = \strtr($matches[1], ['\/' => '/']);
                            $swapData['urlnum'] = 0;
                        } elseif ($swapData['iteration'] > 5) {
                            $error = 'Некорректный ответ сервиса';
                            \file_put_contents('./logs/facebook/face_identify_onload_err_'.\time().'.html', $onload);
                        }
                    } elseif (isset($res['jsmods']['require'][0][0]) && ('ServerRedirect' == $res['jsmods']['require'][0][0])) {
                        $redirect = $res['jsmods']['require'][0][3][0];
                        \file_put_contents('./logs/facebook/face_identify_redirect_'.\time().'.html', $redirect);
                        if (\preg_match("/\/recover\/initiate/", $redirect)) {
                            $swapData['urls'][] = $redirect;
                            $swapData['urlnum'] = 0;
                        } elseif ($swapData['iteration'] > 5) {
                            $error = 'Некорректный ответ сервиса';
                            \file_put_contents('./logs/facebook/face_identify_redirect_err_'.\time().'.html', $onload);
                        }
                        ...
                        if (\strpos($res['errorSummary'], 'не доступен')) {
                            ...
                            \file_put_contents('./logs/facebook/face_identify_locked_'.\time().'.html', \curl_getinfo($rContext->getCurlHandler(), \CURLINFO_HEADER_OUT)."\r\n".$content);
                            if (isset($swapData['session'])) {
                                $mysqli->query("UPDATE isphere.session SET unlocktime=date_add(now(),interval 1 minute),sessionstatusid=6,statuscode='locked' WHERE id=".$swapData['session']->id);
                        ...
                        $error = 'Некорректный ответ сервиса';
                        \file_put_contents('./logs/facebook/face_identify_err_'.\time().'.html', \curl_getinfo($rContext->getCurlHandler(), \CURLINFO_HEADER_OUT)."\r\n".$content);
                    }
                } elseif (\strpos($content, 'заблокированы') && $swapData['iteration'] % 5 == 0) {
                    //                    file_put_contents('./logs/facebook/face_recover_locked_' . time() . '.html', curl_getinfo($rContext->getCurlHandler(),CURLINFO_HEADER_OUT)."\r\n".$content);
                    unset($swapData['urls']);
                    if (isset($swapData['session'])) {
                        $mysqli->query("UPDATE isphere.session SET unlocktime=date_add(now(),interval 1 minute),sessionstatusid=6,statuscode='locked' WHERE id=".$swapData['session']->id);
                        //                        $mysqli->query("UPDATE isphere.session SET proxyid=NULL WHERE sourceid=31 AND proxyid=" . $swapData['session']->proxyid . " AND id<>" . $swapData['session']->id . " ORDER BY lasttime LIMIT 3");
                    ...
                    //                    file_put_contents('./logs/facebook/face_recover_impossible_' . time() . '.html', curl_getinfo($rContext->getCurlHandler(),CURLINFO_HEADER_OUT)."\r\n".$content);
                    unset($swapData['urls']);
                    if (isset($swapData['session'])) {
                    ...
                    \file_put_contents('./logs/facebook/face_recover_'.\time().'.html', \curl_getinfo($rContext->getCurlHandler(), \CURLINFO_HEADER_OUT)."\r\n".$content);
                ...
                \file_put_contents('./logs/facebook/face_search_'.\time().'.html', $content);
                if (\preg_match('/id="empty_result_error">/', $content)) {
                    ...
                    if (!\preg_match("/facebook.com\/settings\?/", $content)) {
                        ...
                        \file_put_contents('./logs/facebook/face_err_'.\time().'.html', $content);
                ...
                */
                \file_put_contents('./logs/facebook/face_'.\time().'.html', $content);
                ...
                */
                ...
                foreach ($tmparray as $key => $val) {
                    ...
                    if (($key > 0) && (\strpos($val, '<') > 0)) {
                        ...
                        if (isset($this->names[$title])) {
                                    ...
                                    if ($comma = \strpos($slplace, ',')) {
                                        ...
                                        if ($val2 && ('Информация скрыта' != $val2) && ('Загрузка...' != $val2)) {
                                            ...
                                            if (isset($this->names[$title2])) {
                                                ...
                                                \file_put_contents('./logs/fields/facebook_'.\time().'_'.$title2, $title2."\n".$val2);
                                            }
                                        }
                                    }
                                }
                            ...
                            \file_put_contents('./logs/fields/facebook_'.\time().'_'.$title, $title."\n".$fortitle);
                        }
                    }
                }
                ...
                \file_put_contents('./logs/facebook/face_photo_'.\time().'.html', $content);
                ...
                */
                ...
                \file_put_contents('./logs/facebook/face_about_'.\time().'.html', $content);
                $data = $swapData['data'];
