...
class InfobipPlugin implements PluginInterface
{
    ...
    private $hlrStatus = ['DELIVRD' => 'Доступен', 'UNDELIV' => 'Недоступен', 'UNKNOWN' => 'Ошибка', 'REJECTD' => 'Не существует', 'EXPIRED' => 'Истек срок'];
    ...
    public function computeRequest(array $params, &$rContext)
    {
        ...
        if (!$error) {
            ...
            //            \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/infobip/'.time().'.txt', $content."\n\n".$swapData['iteration']);
