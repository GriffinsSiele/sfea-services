...
class TCPlugin implements PluginInterface
{
    ...
    private $captcha_service = [['host' => 'api.capmonster.cloud', 'key' => 'afb26cbb248d650ea8b8d88822984242']];
    ...
    public function getSessionData(array $params)
    {
        ...
        $reqId = $params['_reqId'];
        $sessionData = null;
        $mysqli->executeStatement('UPDATE session s SET request_id='.$reqId." WHERE request_id IS NULL AND sessionstatusid=2 AND sourceid=24 AND captcha>'' ORDER BY lasttime limit 1");
