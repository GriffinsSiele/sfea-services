...
{
    private $names = ['День рождения' => ['birthday', 'День рождения', 'День рождения'], 'Родной город' => ['birthplace', 'Родной город', 'Родной город'], 'Город' => ['place', 'Город', 'Город'], 'Образование' => ['education', 'Образование', 'Образование'], 'Место учёбы' => ['school', 'Место учёбы', 'Место учёбы'], 'Военная служба' => ['army', 'Военная служба', 'Военная служба'], 'Карьера' => ['career', 'Карьера', 'Карьера'], 'Место работы' => ['job', 'Место работы', 'Место работы'], 'Места' => ['places', 'Места', 'Места'], 'Дом' => ['livingplace', 'Город проживания', 'Город проживания'], 'Языки' => ['languages', 'Языки', 'Языки'], 'Основная информация' => ['common', 'Основная информация', 'Основная информация', 'block'], 'Контактная информация' => ['contacts', 'Контакты', 'Контакты', 'block'], 'Моб. телефон' => ['mobile_phone', 'Мобильный телефон', 'Мобильный телефон'], 'Доп. телефон' => ['other_phone', 'Дополнительный телефон', 'Дополнительный телефон'], 'Skype' => ['skype', 'Skype', 'Skype', 'skype'], 'Веб-сайт' => ['website', 'Сайт', 'Сайт', 'url:recursive'], 'Сайт' => ['website', 'Сайт', 'Сайт', 'url:recursive'], 'Twitter' => ['twitter', 'Twitter', 'Twitter', 'url:recursive'], 'Facebook' => ['facebook', 'Facebook', 'Facebook', 'url:recursive'], 'Instagram' => ['instagram', 'Instagram', 'Instagram', 'url:recursive'], 'LiveJournal' => ['livejournal', 'LiveJournal', 'LiveJournal', 'url:recursive'], 'Личная информация' => ['personal_info', 'Личная информация', 'Личная информация', 'block'], 'О себе' => ['about', 'О себе', 'О себе'], 'Деятельность' => ['activities', 'Деятельность', 'Деятельность'], 'Интересы' => ['interests', 'Интересы', 'Интересы'], 'Любимые книги' => ['favorite_books', 'Любимые книги', 'Любимые книги'], 'Любимые фильмы' => ['favorite_films', 'Любимые фильмы', 'Любимые фильмы'], 'Любимые игры' => ['favorite_games', 'Любимые игры', 'Любимые игры'], 'Любимые телешоу' => ['favorite_teleshows', 'Любимые телешоу', 'Любимые телешоу'], 'Любимые цитаты' => ['favorite_quotes', 'Любимые цитаты', 'Любимые цитаты'], 'Любимая музыка' => ['favorite_music', 'Любимые музыка', 'Любимые музыка'], 'Группы' => ['groups', 'Группы', 'Группы'], 'Жизненная позиция' => ['viewpoint', 'Жизненная позиция', 'Жизненная позиция'], 'Семейное положение' => ['family', 'Семейное положение', 'Семейное положение'], 'Родители' => ['parents', 'Родители', 'Родители'], 'Мать' => ['mother', 'Мать', 'Мать'], 'Отец' => ['father', 'Отец', 'Отец'], 'Бабушка' => ['grandmother', 'Бабушка', 'Бабушка'], 'Дедушка' => ['grandfather', 'Дедушка', 'Дедушка'], 'Дедушки, бабушки' => ['grandparents', 'Дедушки, бабушки', 'Дедушки, бабушки'], 'Брат' => ['relatives', 'Родственники', 'Родственники'], 'Братья' => ['relatives', 'Родственники', 'Родственники'], 'Сестра' => ['relatives', 'Родственники', 'Родственники'], 'Сёстры' => ['relatives', 'Родственники', 'Родственники'], 'Братья, сёстры' => ['relatives', 'Родственники', 'Родственники'], 'Дочь' => ['children', 'Дети', 'Дети'], 'Сын' => ['children', 'Дети', 'Дети'], 'Дети' => ['children', 'Дети', 'Дети'], 'Внук' => ['grandchildren', 'Внуки', 'Внуки'], 'Внучка' => ['grandchildren', 'Внуки', 'Внуки'], 'Внуки' => ['grandchildren', 'Внуки', 'Внуки'], 'Друзья' => ['friends', 'Друзья', 'Друзья'], 'Друзья онлайн' => ['friends_online', 'Друзья онлайн', 'Друзья онлайн'], 'Подарки' => ['gifts', 'Подарки', 'Подарки'], 'Интересные' => ['interests', 'Интересные страницы', 'Интересные страницы'], 'Фотографии' => ['photos', 'Фотографии', 'Фотографии'], 'Фотоальбомы' => ['albums', 'Фотоальбомы', 'Фотоальбомы'], 'Аудиозаписи' => ['audios', 'Аудиозаписи', 'Аудиозаписи'], 'Видеозаписи' => ['videos', 'Видеозаписи', 'Видеозаписи'], 'подписчик' => ['subscribers', 'Подписчики', 'Подписчики'], 'подписчика' => ['subscribers', 'Подписчики', 'Подписчики'], 'подписчиков' => ['subscribers', 'Подписчики', 'Подписчики'], 'отметка' => ['marks', 'Отметки', 'Отметки'], 'отметки' => ['marks', 'Отметки', 'Отметки'], 'отметок' => ['marks', 'Отметки', 'Отметки'], 'друг' => ['friends', 'Друзья', 'Друзья'], 'друга' => ['friends', 'Друзья', 'Друзья'], 'друзей' => ['friends', 'Друзья', 'Друзья'], 'запись' => ['posts', 'Публикации', 'Публикации'], 'записи' => ['posts', 'Публикации', 'Публикации'], 'записей' => ['posts', 'Публикации', 'Публикации'], 'фотография' => ['photos', 'Фотографии', 'Фотографии'], 'фотографии' => ['photos', 'Фотографии', 'Фотографии'], 'фотографий' => ['photos', 'Фотографии', 'Фотографии'], 'видеозапись' => ['videos', 'Видеозаписи', 'Видеозаписи'], 'видеозаписи' => ['videos', 'Видеозаписи', 'Видеозаписи'], 'видеозаписей' => ['videos', 'Видеозаписи', 'Видеозаписи'], 'аудиозапись' => ['audios', 'Аудиозаписи', 'Аудиозаписи'], 'аудиозаписи' => ['audios', 'Аудиозаписи', 'Аудиозаписи'], 'аудиозаписей' => ['audios', 'Аудиозаписи', 'Аудиозаписи']];

    public function str_uprus($text)
    {
        $up = ['а' => 'А', 'б' => 'Б', 'в' => 'В', 'г' => 'Г', 'д' => 'Д', 'е' => 'Е', 'ё' => 'Ё', 'ж' => 'Ж', 'з' => 'З', 'и' => 'И', 'й' => 'Й', 'к' => 'К', 'л' => 'Л', 'м' => 'М', 'н' => 'Н', 'о' => 'О', 'п' => 'П', 'р' => 'Р', 'с' => 'С', 'т' => 'Т', 'у' => 'У', 'ф' => 'Ф', 'х' => 'Х', 'ц' => 'Ц', 'ч' => 'Ч', 'ш' => 'Ш', 'щ' => 'Щ', 'ъ' => 'Ъ', 'ы' => 'Ы', 'ь' => 'Ь', 'э' => 'Э', 'ю' => 'Ю', 'я' => 'Я', 'ә' => 'Ә', 'ғ' => 'Ғ', 'қ' => 'Қ', 'ң' => 'Ң', 'ө' => 'Ө', 'ұ' => 'Ұ', 'ү' => 'Ү', 'һ' => 'Һ', 'і' => 'І'];
    ...
    {
        $trans = ['Ә' => 'А', 'Ғ' => 'Г', 'Қ' => 'К', 'Ң' => 'Н', 'Ө' => 'О', 'Ұ' => 'У', 'Ү' => 'У', 'Һ' => 'Х', 'І' => 'И'];
    ...
    {
        $title = ['' => 'Поиск в VK', 'vk_person' => 'VK - поиск профилей по имени и дате рождения', 'vk_phone' => 'VК - поиск профилей по номеру телефона', 'vk_email' => 'VК - поиск профилей по email', 'vk_url' => 'VК - профиль пользователя'];
    ...
    public function getSessionData(array $params)
    {
        ...
        $reqId = $params['_reqId'];
        $sessionData = null;
        $mysqli->executeStatement('UPDATE session s SET request_id='.$reqId.' WHERE request_id IS NULL AND sessionstatusid=2 AND (s.proxyid IS NULL OR (SELECT status FROM proxy WHERE id=s.proxyid)=1) AND sourceid=4 AND unix_timestamp(now())-unix_timestamp(lasttime)>3 ORDER BY lasttime limit 1');
        $result = $mysqli->executeQuery("SELECT id,cookies,starttime,lasttime,captcha,token,proxyid,(SELECT concat(server,':',port) FROM proxy WHERE id=s.proxyid) proxy,(SELECT concat(login,':',password) FROM proxy WHERE id=s.proxyid) proxy_auth FROM session s WHERE sourceid=4 AND request_id=".$reqId);
        if ($result) {
    ...
    public function prepareRequest(array $params, &$rContext)
    {
        /** @var \Doctrine\DBAL\Connection $mysqli */
        $mysqli = $params['_connection'];
        /** @var \Doctrine\DBAL\Connection $vkConnection */
        $vkConnection = $params['_vkConnection'];
        ...
        if ('phone' == $checktype) {
            ...
            $result = $vkConnection->executeQuery('SELECT DISTINCT vkId FROM phones WHERE phone='.$swapData['phone'].' LIMIT 10');
            $i = 0;
            while ($result && ($row = $result->fetchAssociative())) {
        ...
        if ('email' == $checktype) {
            $resultData = new ResultDataList();
            $result = $vkConnection->executeQuery("SELECT DISTINCT vkId FROM emails WHERE email='".$swapData['email']."' LIMIT 10");
            $i = 0;
        ...
        */
        ...
        if ('phone' == $checktype || 'email' == $checktype) {
            ...
            $params = ['c[per_page]' => 40, 'c[name]' => 1, 'c[section]' => 'people'];
            if ('person' == $checktype) {
    ...
    public function computeRequest(array $params, &$rContext)
    {
        ...
        if (!$curl_error) {
            ...
            if (!isset($swapData['path'])) {
                //                \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/vk/vk_search_'.time().'.html',$content);
                ...
                if ($found > 20) {
                    ...
                    if (isset($swapData['session'])) {
                        $mysqli->executeStatement("UPDATE session SET unlocktime=date_add(now(),interval 2 minute),sessionstatusid=6,statuscode='empty' WHERE id=".$swapData['session']->id);
                        $mysqli->executeStatement("UPDATE session SET endtime=now(),sessionstatusid=3,statuscode='empty' WHERE used-ifnull(success,0)>=10 AND id=".$swapData['session']->id);
                    }
                    ...
                    if (isset($swapData['session'])) {
                        $mysqli->executeStatement("UPDATE session SET endtime=now(),sessionstatusid=3,statuscode='invalidanswer' WHERE id=".$swapData['session']->id);
                    }
                    unset($swapData['session']);
                    $rContext->setSwapData($swapData);
                    if ($swapData['iteration'] > 3) {
                    ...
                    \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/vk/vk_search_err_'.\time().'.html', $content);
                }
            } elseif (!isset($swapData['uid'])) {
                //                $data = $swapData['data'];
                $data = [];
                $data['link'] = new ResultDataField('url:recursive', 'Link', $swapData['path'], 'Ссылка', 'Ссылка на профиль');
                //                \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/vk/vk'.time().'.html',$content);
                $content = \iconv('windows-1251', 'utf-8//ignore', $content);
                ...
                if (\preg_match('/<div class="login_blocked_about">/', $content)) {
                    if (isset($swapData['session'])) {
                        $mysqli->executeStatement("UPDATE session SET unlocktime=date_add(now(),interval 1 year),sessionstatusid=6,statuscode='blocked' WHERE id=".$swapData['session']->id);
                    }
                    unset($swapData['session']);
                    $rContext->setSwapData($swapData);
                ...
                if (\preg_match('/\\{"user_id":([^,]+),/', $content, $matches) || \preg_match('/"loc":"\\?id=([^"]+)"/', $content, $matches)) {
                    ...
                    if (!isset($initData['phone'])) {
                        $result = $vkConnection->executeQuery('SELECT DISTINCT phone FROM phones WHERE vkId='.$swapData['uid'].' LIMIT 10');
                        $i = 0;
                        while ($result && ($row = $result->fetchAssociative())) {
                            if ($phone_number = \preg_replace('/\\D/', '', $row['phone'])) {
                    ...
                    if (!isset($initData['email'])) {
                        $result = $vkConnection->executeQuery('SELECT DISTINCT email FROM emails WHERE vkId='.$swapData['uid'].' LIMIT 10');
                        $i = 0;
                        while ($result && ($row = $result->fetchAssociative())) {
                            $data['email'.$i++] = new ResultDataField('email', 'Email', $row['email'], 'E-mail', 'E-mail');
                        }
                ...
                if (\preg_match('/<a id="profile_photo_link"[^{]+\\{[^{]+(\\{[^}]+\\})/', $content, $matches)) {
                    ...
                    if (\is_array($a) && isset($a['x'])) {
                        $img = isset($a['w']) ? $a['w'] : (isset($a['z']) ? $a['z'] : (isset($a['y']) ? $a['y'] : $a['x']));
                        // array_pop($a)[0];
                    ...
                    if (\preg_match_all('/<div class="label fl_l">(.*?)<\\/div>.*?<div class="labeled">(.*?)<\\/div>/sim', $short_info, $matches)) {
                        foreach ($matches[1] as $key => $val) {
                            ...
                            if (isset($this->names[$title])) {
                                ...
                                if ('birthday' == $field[0]) {
                                    $repl = [' г.' => '', ' ' => '.', 'января' => '01', 'февраля' => '02', 'марта' => '03', 'апреля' => '04', 'мая' => '05', 'июня' => '06', 'июля' => '07', 'августа' => '08', 'сентября' => '09', 'октября' => '10', 'ноября' => '11', 'декабря' => '12'];
                                    if (1 == \strpos($text, ' ')) {
                                        $text = '0'.$text;
                                    }
                                ...
                                //                                                 \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/fields/vk'.time().'_'.$title , $title."\n".$text);
                            }
                        }
                    }
                }
                    ...
                    foreach ($infoarr as $val) {
                        if (\preg_match('/<span class="profile_info_header">([^<]+)/', $val, $matches)) {
                            ...
                            if (isset($this->names[$title])) {
                                ...
                                if (isset($field[3]) && 'block' == $field[3]) {
                                    foreach ($rows as $row) {
                                        ...
                                        if (isset($this->names[$rowtitle])) {
                                            ...
                                            \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/fields/vk'.\time().'_'.$rowtitle, $rowtitle."\n".$rowtext);
                                        }
                                    }
                                ...
                                ++$counter;
                                $data['other'.$counter] = new ResultDataField('string', 'other'.$counter, $text, $title, $title);
                                \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/fields/vk'.\time().'_'.$title, $title."\n".$text);
                            }
                        }
                    }
                }
                ...
                $data = $swapData['data'];
                //                \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/vk/vkinstagram'.time().'.html',$content);
                ...
                $data = $swapData['data'];
                //                \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/vk/vkfoaf_'.time().'.xml',$content);
                try {
                ...
                if (false !== $foaf) {
                    ...
                    \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/vk/vkfoaf_err_'.\time().'.xml', $content);
                }
                ...
                $data = $swapData['data'];
                //                \App\Utils\Legacy\LoggerUtilStatic::file_put_contents('./logs/vk/vkplaces'.time().'.html',$content);
                $content = \iconv('windows-1251', 'utf-8//ignore', $content);
                $places = [];
