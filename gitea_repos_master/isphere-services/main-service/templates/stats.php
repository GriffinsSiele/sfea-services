...
echo '<option value="0:01"'.('0:01' == $hours ? ' selected' : '').'>За последнюю минуту</option>';
echo '<option value="0:02"'.('0:02' == $hours ? ' selected' : '').'>За последние 2 минуты</option>';
echo '<option value="0:05"'.('0:05' == $hours ? ' selected' : '').'>За последние 5 минут</option>';
echo '<option value="0:15"'.('0:15' == $hours ? ' selected' : '').'>За последние 15 минут</option>';
echo '<option value="0:30"'.('0:30' == $hours ? ' selected' : '').'>За последние 30 минут</option>';
...
$conditions .= ' AND created_at >= '.$fromtime;

$tmpview = 'STAT_'.$userid.'_'.\time();
