...
var Main = function() {
    Java.perform(function () { // avoid java.lang.ClassNotFoundException
        [
            // "java.io.File",
            'w8.e', // BaseHttpRequestBuilder
            'w8.x', // SecretBuilder
            'd9.a', // Hash
            'x8.a', // DromHttpRequestBuilder
            'x8.b', // DromSecretBuilder,
            'w8.o' // HttpParams
        ].forEach(traceClass);
        'p15 е432аа13 12615c25210d818ec1ec9dc7495f520b 1663684894699 1' + 'queivoo1ieNgae2e'
