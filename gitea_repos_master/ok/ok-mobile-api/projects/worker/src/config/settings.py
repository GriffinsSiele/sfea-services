...
RABBITMQ_QUEUE_SESSION = os.getenv("RABBITMQ_QUEUE_SESSION")
RABBITMQ_QUEUE = os.getenv("RABBITMQ_QUEUE")
_RABBITMQ_CONSUMERS = os.getenv("RABBITMQ_CONSUMERS")
RABBITMQ_CONSUMERS = (
    int(str(_RABBITMQ_CONSUMERS).strip('"')) if _RABBITMQ_CONSUMERS else 1
)


SENTRY_URL_WORKER = os.getenv("SENTRY_URL_WORKER")
