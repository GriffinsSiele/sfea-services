...
def parse_dotenv():
    ...
    _RU_CAPTCHA = os.getenv('RU_CAPTCHA')
    ...
    return _PROXY_LOGIN, _PROXY_PASSWORD, _SELENIUM_BROWSER_DRIVER_PATH, _RU_CAPTCHA, _LOG_LEVEL, \
           _MONGO_HOST, _MONGO_PORT, _MONGO_DB, _MONGO_COLLECTION, _MONGO_SERVICE
