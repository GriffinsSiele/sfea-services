...
class SamsungSearchResultParserPerson(AbstractResultParser):
    """Обрабатывает ответ сайта Samsung для пролонгатора person,
    ...
    def parse(self, response: Response) -> dict:
        ...
        if response.status_code == 200:
            ...
            second_definition = get(response_js, "rtnMap.userLoginIDVOList")
            second_definition_blocked = get(response_js, "nextURL")
